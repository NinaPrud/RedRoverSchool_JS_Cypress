...
// console.log(person3.husbend.name)
...
// _!обязательно!_ должен быть заключен в кавычки:
// let number
// number = 9

// let user = new Object() // так сразу значение передать нельзя, только создать
...
// ===== через оператор in check the key (ищет ТОЛЬКО по КЛЮЧУ!!!!)
...
// console.log( 'name1' in obj.job) // true
...
// //Operator in мщжно запихнуть в if  и если ключ есть, вывести его значение

// if ("name" in userInfo){            // check if key  -name- in object
//    console.log(userInfo.name)
// }

//console.log(userInfo.address.street)  // если нету таких ключей выдаст ОШИБКУ

//опциональная цепочка
//console.log(userInfo?.address?.street) // если нету таких ключей выдаст undefined
