...
//    step4, '<br>', step5, '<br><br>', step6, '<br><br>')
   ...
   if(topping == salmon)
           {
   console.log(`P.S.:And in a cafe ${salmonSandwich} costs 
   ${priceSalmon} dollars`)
            }
   else if(topping == turkey)
            {
   console.log(`P.S.:And in a cafe ${turkeySandwich} costs 
   ${priceTurkey}  dollars`)
            }
   else if(topping == bacon)
            {
   console.log(`P.S.:And in a cafe ${baconSandwich} costs 
   ${priceBacon} dollars`)  
            }
}
...
{
    console.log("Please, wait more 5 minets") 
} 
else
{
    console.log("I don't know what is going here!") 
}